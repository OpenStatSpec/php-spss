...
{
    private const BYTE_COMPRESSED_SAV = '';

    private const ZLIB_COMPRESSED_ZSAV = '';
    ...
    public function testReadsHavenCompressedRowsWithPaddedOpcodeClusters(
        ...
        self::assertSame(['NUMBER', 'TEXT'], array_map(
            static fn($variable): string => $variable->name,
            $reader->variables,
        ));
        self::assertSame([
            [1.0, 'abc'],
